        ...
        <div class="container">
              ...
              <div class="d-flex justify-content-end">
                    ...
                    <form class="form-inline" action="/dashboard/aduan-masuk">
                        <input class="form-control mr-sm-2" type="search" name="search" placeholder="Search..Aduan" aria-label="Search">
...
<div class="modal fade" id="exampleModalimage{{ $aduan->id }}" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
            <div class="container">
                <img src="{{ asset('storage/' .$aduan->gambar) }}" class="img-thumbnail rounded mx-auto d-block" data-toggle="modal"
                data-target="#exampleModalimage{{ $aduan->id }}" alt="{{ $aduan->gambar }}" width="720px">
